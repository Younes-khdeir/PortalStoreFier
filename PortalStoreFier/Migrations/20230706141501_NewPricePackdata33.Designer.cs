...
namespace PortalStoreFier.Migrations
{
    ...
    [Migration("20230706141501_NewPricePackdata33")]
    partial class NewPricePackdata33
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PortalStoreFier.Models.NewPricePack", b =>
                {
                    b.HasOne("PortalStoreFier.Models.Customer", "Customer")
                        .WithMany("NewPricePack")
                        .HasForeignKey("CustomerId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("PortalStoreFier.Models.PricePack", "PricePack")
                        .WithMany("NewPricePack")
                        .HasForeignKey("PricePackId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
